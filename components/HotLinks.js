...
export default function HotLinks() {
  ...
  return (
        ...
        <div className=' flex justify-center flex-wrap mt-5 space-x-2 text-white' >  
            
            {
              iconUrls.map(content => {
                ...
                return (
                      <div key={id} className={isItem ? 'h-[50px] w-[184px] flex items-center justify-center  bg-deepblack  rounded '  : 'bg-tpblack h-[50px] w-[184px] flex items-center justify-center rounded '}    > 
