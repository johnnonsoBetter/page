...
const Search = () => {
  ...
  return (
    <div className=" w-[630px] mr-4 justify-center ">
      ...
      <label className="flex items-center bg-lowdark py-1  rounded-lg px-2">
        ...
        <input type="email" name="email" className="mt-1  px-2 pb-1 focus:outline-none border-0 font-semibold bg-lowdark text-lowpink w-full  sm:text-sm" placeholder="Lorem ipsum" />
      </label>
    </div>
  )
}
